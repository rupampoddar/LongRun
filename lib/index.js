export class LongRun {
    ...
    getSetupOptions(funcName) {
        ...
        if (execScope !== null &&
            ...
            return {
                ...
                triggerEveryNHours: triggerEveryNHours === null
                    ? undefined
                    : parseInt(triggerEveryNHours),
                triggerEveryNDays: triggerEveryNDays === null ? undefined : parseInt(triggerEveryNDays),
                triggerEveryNWeeks: triggerEveryNWeeks === null
                    ? undefined
    ...
    getArgs(funcName) {
        const funcArgs = this.properties.getProperty(LongRun.PREFIX_FUNC_ARGS + funcName);
        if (funcArgs) {
...
LongRun.PREFIX_TRIGGER_ID = "trigger_";
...
LongRun.PREFIX_FUNC_ARGS = "args_";
LongRun.PREFIX_TASK_COMPLETED_INDEX = "task_completed_index_";
