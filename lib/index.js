    ...
    getSetupOptions(funcName) {
        ...
        if (execScope !== null &&
            ...
            return {
                ...
                triggerEveryNHours: triggerEveryNHours === null ? undefined : parseInt(triggerEveryNHours),
                triggerEveryNDays: triggerEveryNDays === null ? undefined : parseInt(triggerEveryNDays),
                triggerEveryNWeeks: triggerEveryNWeeks === null ? undefined : parseInt(triggerEveryNWeeks),
            };
        }
        return null;
    }
